...
use uni_v4_structure::{
    BaselinePoolState, L1FeeConfiguration, L2FeeConfiguration, PoolId, PoolKey,
    fee_config::FeeConfig,
    pool_registry::PoolRegistry,
    updates::{
        l1::{L1PoolUpdate, Slot0Update},
        l2::L2PoolUpdate
    }
};
    ...
    Self: PoolEventProcessor<T>
{
    ...
    fn handle_new_pool(&mut self, pool_key: PoolKey, block_number: u64, fee_cfg: T::FeeConfig) {
        self.factory
