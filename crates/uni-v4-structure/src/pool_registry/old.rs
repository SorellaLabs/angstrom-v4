...
//     pub fn get_pools_by_token_pair(&self, token0: Address, token1: Address)
// -> Vec<&PoolKey> {         // Normalize token order
...
//             .values()
//             .filter(|pool_key| {
//                 pool_key.currency0 == normalized_token0 && pool_key.currency1
// == normalized_token1             })
//             .collect()
//     }
